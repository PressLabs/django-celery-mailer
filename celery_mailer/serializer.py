...
def serialize(email_message):
    ...
    EmailMessage object is serialized into JSON.
    ...
    return json.dumps({
        ...
        'from_email': email_message.from_email, 'to': email_message.to,
        'bcc': email_message.bcc, 'attachments': email_message.attachments,
        'headers': email_message.extra_headers, 'cc': email_message.cc,
    })


def deserialize(serialized):
    """Util for deserializing json data and constructing a new EmailMessage object.
    ...
    return EmailMessage(
        subject=mail_props.get('subject', u''), body=mail_props.get('body', u''),
